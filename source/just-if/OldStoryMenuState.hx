...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		luckText = new FlxText(FlxG.width, FlxG.height, 0, "good luck " + CoolUtil.getpcUSER() + "..." /**OH SHIT**/, 37);
		luckText.screenCenter();
		luckText.scrollFactor.set();
		luckText.setFormat(Paths.font('sonic-cd.ttf'), 37, FlxColor.RED, LEFT);
	...
	function selectWeek()
	{
		...
		{
			if(WeekData.weeksList[curWeek] != 'tutorial')
			{
