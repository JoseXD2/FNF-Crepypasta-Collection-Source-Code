...
class PauseSubState extends MusicBeatSubstate
{
	...
	public static var botthing:Bool = ClientPrefs.gameplaySettings.get('botplay');
	...
	override function update(elapsed:Float)
	{
		...
		if (accepted)
		{
			...
			switch (daSelected)
			{
				...
				case 'Botplay':
					botthing = !botthing;
					ClientPrefs.gameplaySettings.set('botplay', botthing);
				case "Exit to menu":
					...
					FlxG.sound.playMusic(Paths.music('Vhs_Static', 'creepy'));
